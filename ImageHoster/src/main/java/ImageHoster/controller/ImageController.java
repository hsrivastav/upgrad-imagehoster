...
public class ImageController {
   ...
   // 
    ...
    public String showImage(@PathVariable("id") Integer id, Model model) {
        ...
        List<Comment> comments = commentService.getCommentByImage(image);
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer
    		imageId,Model model,HttpSession session,RedirectAttributes
    		redirectAttributes) {
